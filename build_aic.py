...
def front_aic(doc):
    ...
    me = (
        ...
        "The estimand was the per-protocol risk difference and risk ratio, with "
    ...
    res = (
        ...
        f"(+{P['rmst_diff']:.2f} days) and in ventilator-free days "
        f"(+{P['vfd_diff']:.2f} days). All six sensitivity and robustness "
        f"analyses remained significant, including an extended 40-covariate "
        f"adjustment, alternative weight truncation and a doubly robust "
        f"estimator; all nine exploratory FiO\u2082\u00d7PEEP "
    ...
    con = (
        ...
        "restricted mean survival and more ventilator-free days, consistent across "
        "all sensitivity analyses and external validation in an independent "
        "multi-centre cohort. Among patients already on low respiratory "
